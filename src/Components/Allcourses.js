...
import slide1 from './assets/allCourses-1.jpg'
import slide2 from './assets/allCourses-2.jpg'
import slide3 from './assets/trending-2.jpg'
import slide4 from './assets/trending-1.jpg'
  const Allcourses = () => {
    return (
      <div>
        <Navbar/>
        <h3 style={{marginLeft:'45%',marginBottom:'2%',marginTop:'2%'}}>All Courses</h3>
