...
import slide1 from './assets/pop-1.jpg'
import slide2 from './assets/pop-2.jpg'
import slide3 from './assets/bannerimages/9.jpg'
import slide4 from './assets/bannerimages/11.jpg'
const Allcourses = () => {
  return (
    <div>
      <Navbar/>
      <h3 style={{marginLeft:'45%',marginBottom:'2%',marginTop:'2%'}}>Most popular</h3>
