            ...
            {product ?
                <div className='myprod-container'>
                    ...
                    <div className='prod-data'>
                        <p className='prod-head' style={{color:'white'}}>{product.producttitle}</p>
                        <p className='prod-keyspecs' style={{color:'white'}}>{product.keyspecs}</p>
                        <div className='specific-price-container'>
                            <p className='mrp' style={{color:'white'}}>MRP: <p className='rate'>₹{mrp}</p></p>
                            <p className='saleprice' style={{color:'white'}}>Discount Price: <p className='rate'>₹{saleprice}</p></p>
                            <p className='yousave' style={{color:'white'}}>You Save: ₹{mrp - saleprice}</p>
                        </div>
                        <p className='prod-details-head' style={{color:'white'}}>Details</p>
                        <p className='prod-description' style={{color:'white'}}>{product.description}</p>
                ...
                : <p>Loading...</p>}
            <p className='prod-details-head2' style={{color:'#B4D4FF'}}>Similar Items</p>
